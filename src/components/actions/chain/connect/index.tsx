...
import AccountBalance from "../balance/eth"
                ...
                address ?
                    <>
                        <Button className="hidden md:inline-block">
                            <svg fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" width={20} className="mr-1" aria-hidden="true">
                ...
                <Modal.Body>
                    ...
                    <ul className="my-4 space-y-3">
                        {connectors
                            .filter((x) => x.ready)
                            .map((x) => (
                                <li key={x.id} onClick={() => connect({ connector: x })}>
                                    {
                                        x.id == 'metaMask' &&
